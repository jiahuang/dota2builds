INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Clarity","items/Clarity.jpg","","Consumables","50",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Tango","items/Tango.jpg","","Consumables","90",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Healing Salve","items/HealingSalve.jpg","","Consumables","100",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Smoke of Deceit","items/SmokeofDeceit.jpg","","Consumables","100",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Town Portal Scroll","items/TownPortalScroll.jpg","","Consumables","135",2);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Dust of Appearance","items/DustofAppearance.jpg","","Consumables","180",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Animal Courier","items/AnimalCourier.jpg","","Consumables","150",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Sentry Ward","items/SentryWard.jpg","","Consumables","200",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Observer Ward","items/ObserverWard.jpg","","Consumables","200",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Flying Courier","items/FlyingCourier.jpg","","Consumables","370",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Bottle","items/Bottle.jpg","","Consumables","600",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Quelling Blade","items/QuellingBlade.jpg","Demolish","Armaments","225",2);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Stout Shield","items/StoutShield.jpg","Damage Block","Armaments","250",2);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Magic Stick","items/MagicStick.jpg","","Arcane","200",2);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Gem of True Sight","items/GemofTrueSight.jpg","True Sight","Arcane","700",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Morbid Mask","items/MorbidMask.jpg","Lifesteal","Arcane","900",2);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Blink Dagger","items/BlinkDagger.jpg","","Arcane","2150",2);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Ring of Basilius","items/RingofBasilius.jpg","+6 Damage<br/>+1 Armor<br/>Mana Aura<br/>Armor Aura<br/><br/> (Passive)<br/>Gives +0.65 mana regeneration to all allies within a 900 radius. Mana regeneration aura does not stack with Vladmir's Offering, Ring of Aquila or another Ring of Basilius.<br/><br/>Armor Aura (Passive)<br/>Gives +2 armor to all allied heroes within a 900 radius. The ring can be toggled to also affect any other units. Does not stack with armor auras from Assault Cuirass, Vladmir's Offering or other Rings of Basilius.","Support","500",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Headdress","items/Headdress.jpg","+2 All Attributes<br/>Regeneration Aura<br/><br/>Regeneration Aura (Passive)<br/>Gives +3 HP regeneration to all allied units in a 500 radius.","Support","603",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Dagon","items/Dagon.jpg","+13/15/17/19/21 Intelligence<br/>+3 All Attributes<br/>+9 Damage","Caster","2805",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Aghanim's Scepter","items/AghanimsScepter.jpg","+10 All Attributes<br/>+200 HP<br/>+150 mana<br/>Ultimate Upgrade (passive)<br/><br/>Ultimate Upgrade (Passive)<br/>Upgrades the ultimate of certain heroes when acquired.","Caster","4200",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Crystalys","items/Crystalys.jpg","+35 Damage<br/>Critical Strike<br/><br/>Critical Strike (Passive)<br/>Gives a 20% chance to deal 1.75x normal damage on an attack.","Weapons","2150",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Battle Fury","items/BattleFury.jpg","+65 Damage<br/>+6 HP/sec Regeneration<br/>+150% Mana Regeneration<br/>Cleave<br/><br/>Cleave (Passive)<br/>Grants his wielder a 35% Cleave in 225 radius on attack. Cleave does not work for ranged units. Fully stacks with other Battle Furies and Cleave abilities.","Weapons","4350",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Radiance","items/Radiance.jpg","+60 Damage<br/>Burn Damage<br/><br/>Burn Damage (Passive)<br/>Deals 40 magical damage per second in a 650 radius.","Weapons","5150",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Daedalus","items/Daedalus.jpg","+81 Damage<br/>Critical Strike<br/><br/>Critical Strike (Passive)<br/>Gives a 25% chance to deal 2.5x normal damage on an attack.","Weapons","5750",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Vanguard","items/Vanguard.jpg","+6 HP/sec regeneration<br/>+250 HP<br/>Damage Block<br/><br/>Damage Block (Passive)<br/>Gives a 70% chance to block 40 damage if the owner is melee or block 20 damage if the owner is ranged.","Armor","2225",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Bloodstone","items/Bloodstone.jpg","+500 HP<br/>+400 Mana<br/>+9 HP/sec Regeneration<br/>+200% Mana Regeneration<br/>Bloodpact<br/>6 Charges<br/><br/>Bloodpact (Passive)<br/>The Bloodstone relishes the thrill of combat, and grows in power as the bearer's enemies die around him. Every time an enemy hero dies in 1675 radius, the Bloodstone gains 1 charge. When the bearer dies, he restores 400 + 30 per charge HP to all allies in a 1675 radius and loses a third (rounded down) of its charges. While dead, the bearer has 1800/1800 radius vision around where he died, and earns experience in a 1000 radius at that location. The Bloodstone also reduces the impact of death on its bearer.","Armor","5050",1);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Linken's Sphere","items/LinkensSphere.jpg","+15 All Attributes<br/>+10 Damage<br/>+6 HP/sec regeneration<br/>+150% mana regeneration<br/>Spell Block &lt;sm2>Linken's Sphere.mp3&lt;/sm2><br/><br/>Spell Block (Passive)<br/>Blocks most targeted spells once every 20 seconds.","Armor","5175",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Assault Cuirass","items/AssaultCuirass.jpg","+10 Armor<br/>+35 Attack Speed<br/>Positive Armor Aura<br/>Negative Armor Aura<br/>Attack Speed Aura<br/><br/> (Passive)<br/>Adds 5 armor to friendly units within 900 radius of the carrier. Does not stack with armor auras from Assault Cuirass, Ring of Basilius, Ring of Aquila or Vladmir's Offering.<br/><br/>Negative Armor Aura (Passive)<br/>Reduces the armor of enemy units within 900 radius of the carrier by 5.<br/><br/>Attack Speed Aura (Passive)<br/>Increases the attack speed of all friendly units within 900 radius by 20.","Armor","5350",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Heart of Tarrasque","items/HeartofTarrasque.jpg","+40 Strength<br/>+300 HP<br/>Health Regeneration<br/><br/> Health Regeneration  (Passive)<br/>Regenerates 2% of the bearer's total HP per second. Disabled if the bearer took damage from a player-controlled unit or Roshan in the last 6 seconds (4 for melee.) Does not stack with itself.","Armor","5500",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Sange","items/Sange.jpg","+16 Strength<br/>+10 Damage<br/>Lesser Maim<br/><br/>Lesser Maim (Passive)<br/>Gives a 15% chance on attack to slow movement speed and attack speed by 20% for 4 seconds.","Artifacts","2150",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Yasha","items/Yasha.jpg","+16 Agility<br/>+15 Attack Speed<br/>+10% Movement Speed","Artifacts","2150",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Maelstrom","items/Maelstrom.jpg","+24 Damage<br/>+25 Attack Speed<br/>Chain Lightning<br/><br/>Chain Lightning (Passive)<br/>Gives a 25% chance on attack to release a Chain Lightning that hits four units, dealing 120 magical damage to each, 500 bounce range. Unique attack modifier on proc.","Artifacts","2700",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Desolator","items/Desolator.jpg","+60 Damage<br/>Corruption<br/><br/>Corruption (Passive)<br/>Causes attacks to place a buff that reduces armor by 6. Lasts 7 seconds and works on buildings. Unique attack modifier.","Artifacts","4100",0);

INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Sange and Yasha","items/SangeandYasha.jpg","Movement Speed and Attack Speed bonus does not stack with Yasha, Sange and Yasha, or Manta Style.<br/>+16 Agility<br/>+16 Strength<br/>+12 Damage<br/>+15 Attack Speed<br/>+12% Movement Speed<br/>Greater Maim<br/><br/>Greater Maim (Passive)<br/>Gives a 15% chance on attack to slow movement speed and attack speed by 30% for 4 seconds.","Artifacts","4300",0);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Orb of Venom","items/OrbofVenom.jpg","Poison Attack","Secret Shop","350",1);
...
INSERT INTO tbl_items (name, img, description, shop, price, shopType) 
  VALUES("Cheese","items/Cheese.jpg","","Drop Only","0",0);
